...
import { logout, selectUserAuth, selectAdminAuth } from '../../store/authSlice.js';
...
const Header = () => {
  ...
  // Get authentication states from Redux
  ...
  const menuItems = [
    ...
    ...(userAuth || adminAuth ? [{
      to: adminAuth ? '/admin/dashboard' : '/dashboard', 
      icon: <FaTachometerAlt />, 
      label: 'Dashboard'
    }] : []),
    { to: '/services', icon: <FaClipboardList />, label: 'Services' },
    ...
    <header className="bg-dark-primary/80 backdrop-blur-sm shadow-lg fixed w-full z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          ...
          />
          <span className="text-2xl font-bold text-light-blue">VRV Security</span>
        </Link>
